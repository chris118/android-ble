...
import com.hhit.hhble.widget.fresco.ImageDraweeView;
...
public class BaseViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ImageDraweeView setImageDraweeView(@IdRes int resId, int width, int height, @NonNull String url){
        ImageDraweeView view = getView(resId);
        view.resizeTodp(width, height);
    ...
    public ImageDraweeView setImageDraweeView2(@IdRes int resId, int width, int height, @NonNull String url){
        ImageDraweeView view = getView(resId);
        view.resize(width, height);
        view.setImageURL(url);
        view.setVisibility(View.VISIBLE);
